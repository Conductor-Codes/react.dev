...
const DocumentationStatistics = ({
  ...
  // Use useMemo to optimize expensive data processing
      ...
      pageViewData
        ...
        .filter((page) => {
          return (
            ...
            page.difficulty === selectedDifficulty
          );
        })
        ...
        .map((page) => {
          ...
          const lastUpdated = new Date(page.lastUpdated);
          const monthsOld =
            (new Date() - lastUpdated) / (30 * 24 * 60 * 60 * 1000);
  ...
  const getEfficiencyClass = useMemo(() => {
    return (completionRate, timeSpent) => {
